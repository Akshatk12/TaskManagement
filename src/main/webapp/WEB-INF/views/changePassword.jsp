...
<body style="background-color: #fffaf0;">
	...
	<form:form action="changepwd" method="post" modelAttribute="changePassword"
    ...
    border-radius: 15px;border: 1px solid lightgray;">
		...
		<fieldset>
			...
			<div class="form-group">
				...
				<form:password required="required" path="currPassword" class="form-control" />
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">New Password</label>
				<form:password required="required" path="newPassword" class="form-control" />
			</div>
			<div class="form-group">
				<label for="exampleInputEmail1">Confirm Password</label>
				<form:password required="required" path="confirmPassword" class="form-control" />
			</div>
